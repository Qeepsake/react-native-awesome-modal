...
class AwesomeModal extends React.Component {
    ...
    constructor(props) {
        super(props);
        const yPositionBottomMargin = react_native_1.Platform.OS === 'android' ? (props.hasTabBar ? 67 : 25) : 0;
        /** State */
        this.state = {
            modalHeight: 0,
            opacityAnimation: new react_native_1.Animated.Value(0),
            translateYAnimation: new react_native_1.Animated.Value(DEVICE_HEIGHT * -1.5),
