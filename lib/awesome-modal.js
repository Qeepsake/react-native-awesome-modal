...
import { Animated, Dimensions, Platform, ScrollView, TouchableWithoutFeedback, View, } from 'react-native';
import SafeArea from 'react-native-safe-area';
export class AwesomeModal extends React.Component {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        ...
        this.onSafeAreaInsetsForRootViewChange(await SafeArea.getSafeAreaInsetsForRootView());
    }
    ...
    onSafeAreaInsetsForRootViewChange(insets) {
        ...
        this.setState(() => {
             ...
             */
            const newBottomPadding = insetBottom + Platform.OS === 'android' ? (hasTabBar ? 67 : 25) : 0;
            return {
    ...
    render() {
        ...
        return (<View style={topContainerStyle}>
        <TouchableWithoutFeedback onPress={this.onTouchOutside}>
          <Animated.View style={[defaultModalOverlayStyle, modalOverlayStyle]}/>
        ...
        <Animated.View onLayout={(event) => {
             ...
             */
            const layoutHeight = _get(event, 'nativeEvent.layout.height', null) || 350;
            this.setState(() => {
