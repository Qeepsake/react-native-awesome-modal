...
const App: () => React$Node = () => {
  ...
  const modalRef = useRef<AwesomeModal | null>(null);
      ...
      <AwesomeModal
        ...
        <View style={styles.modalContentContainerStyle}>
          ...
          <Text style={styles.modalContentTextStyle}>
            <Text>
              You can create a useRef to control the modal (i.e. close the
              modal/ have ScrollView scroll to the top) or press outside the
              modal to close it.
            </Text>
          </Text>
        </View>
        <TouchableOpacity
          onPress={() => modalRef?.current?.scrollToTop()}
